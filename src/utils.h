...
[[nodiscard]] quint8 utilsAsciiToScreenCode(State* state, quint8 ascii);
[[nodiscard]] quint8 utilsAsciiToCommodore8Bit(quint8 ascii);
[[nodiscard]] quint8 utilsAsciiToAtari8Bit(quint8 ascii);
