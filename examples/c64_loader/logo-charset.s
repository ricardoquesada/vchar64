...
.byte $fa,$ee,$aa,$aa,$aa,$aa,$aa,$aa,$ff,$ee,$aa,$aa,$aa,$aa,$aa,$aa	; 32
.byte $ab,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$3f,$4c,$3f,$4c,$cc,$90,$9c,$90	; 48
.byte $5f,$7e,$fa,$ea,$aa,$aa,$aa,$aa,$ab,$ab,$ab,$ab,$aa,$aa,$aa,$aa	; 64
.byte $aa,$ee,$bb,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$fa,$ae,$e2,$bc,$f2,$ca	; 80
.byte $aa,$aa,$ba,$bb,$be,$bb,$af,$ae,$aa,$aa,$bb,$ee,$ab,$ea,$ae,$aa	; 96
.byte $aa,$aa,$aa,$ef,$ff,$fe,$bb,$ee,$aa,$ae,$bb,$aa,$aa,$aa,$aa,$aa	; 112
.byte $84,$a6,$a6,$a6,$a2,$aa,$aa,$aa,$ca,$ea,$ea,$ea,$2a,$aa,$aa,$aa	; 128
.byte $45,$51,$45,$41,$07,$07,$17,$07,$c2,$f6,$f2,$f6,$f1,$3d,$f0,$3c	; 144
.byte $7a,$7a,$6a,$6a,$ea,$ea,$aa,$aa,$aa,$aa,$aa,$aa,$ab,$a9,$ab,$ab	; 160
.byte $6a,$6a,$6a,$7a,$ca,$da,$ca,$ce,$30,$3c,$30,$3c,$cc,$8f,$8c,$8f	; 176
.byte $4b,$6a,$6a,$6a,$2a,$aa,$aa,$aa,$a9,$aa,$aa,$aa,$aa,$ea,$ba,$aa	; 192
.byte $40,$41,$50,$40,$47,$11,$47,$53,$5d,$76,$76,$76,$76,$7a,$7a,$7a	; 208
...
.byte $aa,$bb,$ae,$aa,$aa,$ae,$ab,$aa,$eb,$3a,$ee,$3b,$8b,$8f,$8b,$8f	; 272
...
.byte $aa,$ee,$bb,$aa,$aa,$fe,$ff,$aa,$ba,$22,$ba,$33,$f8,$bc,$fc,$ec	; 368
.byte $aa,$aa,$00,$ff,$ff,$fb,$be,$eb,$aa,$aa,$aa,$aa,$aa,$aa,$a9,$aa	; 384
.byte $aa,$ab,$ae,$aa,$aa,$aa,$aa,$ea,$fb,$bf,$ff,$aa,$aa,$aa,$aa,$aa	; 400
.byte $a3,$a3,$a3,$b3,$8f,$8c,$df,$cf,$fe,$fe,$fb,$0c,$aa,$aa,$aa,$aa	; 416
.byte $40,$40,$41,$50,$15,$b4,$9d,$b4,$f5,$dd,$75,$df,$aa,$aa,$aa,$aa	; 432
.byte $aa,$aa,$aa,$aa,$aa,$aa,$aa,$ea,$77,$15,$11,$77,$aa,$aa,$aa,$aa	; 448
.byte $aa,$aa,$aa,$aa,$aa,$ff,$bf,$aa,$33,$cc,$33,$00,$ab,$ab,$ec,$bb	; 464
.byte $ea,$ea,$ea,$ca,$7a,$7a,$7a,$12,$f2,$32,$f2,$f2,$00,$fb,$ee,$fb	; 480
...
.byte $ae,$ae,$ba,$fa,$ab,$a8,$ab,$a8,$aa,$aa,$aa,$aa,$aa,$ff,$fe,$aa	; 560
.byte $ea,$ea,$aa,$aa,$aa,$ba,$ba,$8a,$bf,$bf,$fe,$ee,$ba,$ee,$bb,$ea	; 576
.byte $1c,$1e,$1e,$0e,$12,$1a,$5a,$1a,$aa,$aa,$aa,$aa,$f7,$51,$d0,$44	; 592
.byte $aa,$aa,$aa,$aa,$5d,$f7,$dd,$f5,$aa,$aa,$aa,$aa,$75,$df,$77,$df	; 608
...
.byte $aa,$ff,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$fe,$fb,$aa	; 736
.byte $04,$41,$04,$5f,$aa,$aa,$aa,$aa,$33,$32,$3b,$2b,$ee,$ee,$aa,$aa	; 752
.byte $ab,$ab,$aa,$ae,$8b,$ef,$bf,$ff,$aa,$aa,$aa,$aa,$aa,$ba,$ae,$be	; 768
.byte $b3,$a3,$a0,$a3,$ac,$a9,$a8,$a9,$aa,$aa,$aa,$aa,$aa,$ba,$ea,$aa	; 784
.byte $aa,$aa,$aa,$aa,$aa,$bb,$ee,$aa,$aa,$aa,$aa,$aa,$aa,$bb,$ae,$aa	; 800
.byte $b3,$a2,$a3,$a2,$ab,$ab,$ab,$ab,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$aa	; 816
.byte $aa,$aa,$aa,$aa,$aa,$ff,$ff,$aa,$a3,$a3,$a4,$b7,$8c,$90,$90,$d0	; 832
.byte $2a,$2a,$2a,$3a,$ca,$ca,$ce,$ce,$73,$4f,$3f,$4c,$31,$01,$41,$41	; 848
.byte $f2,$32,$06,$33,$01,$30,$01,$01,$aa,$aa,$aa,$ab,$a9,$a9,$a8,$ad	; 864
.byte $ab,$ab,$e8,$aa,$aa,$ea,$ba,$aa,$aa,$bb,$ee,$aa,$aa,$fe,$fb,$aa	; 880
.byte $aa,$ff,$ff,$aa,$aa,$ff,$ff,$aa,$0c,$0f,$33,$0f,$33,$0c,$ff,$cb	; 896
.byte $aa,$2a,$2a,$2a,$ca,$ca,$ca,$ca,$bb,$ac,$ee,$ba,$aa,$aa,$aa,$aa	; 912
.byte $aa,$ff,$ff,$aa,$aa,$aa,$aa,$aa,$ff,$ff,$ff,$ff,$cf,$cf,$cc,$c3	; 928
.byte $aa,$ee,$bb,$aa,$aa,$ee,$ba,$aa,$a2,$e2,$b2,$fa,$fc,$ee,$fc,$fe	; 944
.byte $ab,$aa,$aa,$aa,$aa,$ea,$ba,$aa,$aa,$ff,$bf,$aa,$aa,$ee,$bb,$aa	; 960
.byte $aa,$ba,$ee,$aa,$aa,$aa,$aa,$aa,$aa,$fe,$fb,$aa,$aa,$ee,$bb,$aa	; 976
.byte $f2,$f2,$f0,$bf,$bb,$ae,$ef,$aa,$aa,$aa,$aa,$aa,$aa,$ff,$bb,$aa	; 992
.byte $aa,$ff,$bf,$aa,$aa,$ef,$bb,$aa,$9d,$af,$a5,$af,$a5,$a9,$a9,$ab	; 1008
.byte $44,$11,$40,$44,$40,$d0,$90,$d3,$aa,$ee,$bb,$aa,$aa,$aa,$aa,$aa	; 1024
.byte $4f,$73,$4f,$73,$cc,$3c,$cc,$3c,$aa,$ee,$bb,$aa,$aa,$ee,$bb,$aa	; 1040
.byte $ab,$aa,$aa,$aa,$aa,$ee,$ba,$aa,$10,$00,$44,$51,$ab,$ab,$a8,$ab	; 1056
.byte $aa,$ef,$bb,$aa,$aa,$ee,$aa,$a6,$46,$02,$77,$33,$fc,$fd,$fc,$fc	; 1072
.byte $aa,$aa,$88,$22,$bb,$ef,$bf,$fe,$aa,$aa,$aa,$aa,$aa,$ae,$ab,$6a	; 1088
.byte $ea,$ff,$aa,$aa,$aa,$aa,$aa,$aa,$aa,$6a,$da,$f6,$7d,$5f,$55,$10	; 1104
.byte $aa,$aa,$aa,$aa,$aa,$6a,$fa,$f6,$ae,$a6,$a6,$9d,$b7,$b7,$b7,$77	; 1120
.byte $aa,$ee,$ba,$aa,$aa,$aa,$aa,$a8,$5d,$1f,$b7,$b5,$8d,$ac,$ac,$a3	; 1136
