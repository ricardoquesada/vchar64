...
TRANSLATIONS = $$prependAppend(LANGUAGES, $$PWD/vchar64_, .ts)
...
win32 {
    ...
    TARGET_DIR = ../bin/VChar64.app/Contents/Translations
} else {
    TARGET_DIR = ../share/vchar64/translations
}
...
qmfiles.files = $$prependAppend(LANGUAGES, $$OUT_PWD/$$TARGET_DIR/vchar64_, .qm)
qmfiles.path = $${PREFIX}/share/vchar64/translations
